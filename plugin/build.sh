...
cat > "$OUTPUT_DIR/meta.json" << 'EOF'
{
    ...
    "version": "1.4.0.0",
    "targetAbi": "10.11.0.0",
    "changelog": "Chronological sweep scheduler with priority preemption; whole-word team matching fix; internal timer registry; scoring gate removed; channel ignore list; structured game list logging",
    "status": "Active",
    "autoUpdate": false,
